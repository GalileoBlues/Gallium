...
4. Make the directory `/usr/share/X11/xkb/symbols`, then copy the contents of the `xkb` folder to it.
...
6. To make it apply in a graphical environment, use your compositor/DE's settings program or configuration file to select either `gallium_rowstag` or `gallium_colstag`.
