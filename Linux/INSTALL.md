...
6. To make it apply in a graphical environment, use your compositor/DE's settings program or configuration file to select either `gallium_rowstag` or `gallium_colstag` after editing your system's XKB configuration.
